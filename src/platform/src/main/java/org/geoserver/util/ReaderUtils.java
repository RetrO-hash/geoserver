...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Error configuring DocumentBuilderFactory securely", e);
            throw new RuntimeException("Error configuring DocumentBuilderFactory securely", e);
        }
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Error configuring SAXParserFactory securely", e);
                throw new RuntimeException("Error configuring SAXParserFactory securely", e);
            }
