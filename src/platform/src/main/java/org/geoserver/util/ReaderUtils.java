...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Failed to set security features for DocumentBuilderFactory", e);
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Failed to set security features for SAXParserFactory", e);
                throw new RuntimeException(e);
            }
