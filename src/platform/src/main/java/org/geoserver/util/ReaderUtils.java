 ...
 * ReaderUtils purpose.
 *
 * <p>This class is intended to be used as a library of XML relevant operation for the GeoTools XMLConfigDigester class.
 *
 * <p>
 *
...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Cannot set disallow-doctype-decl on DocumentBuilderFactory", e);
            throw new RuntimeException("Cannot set disallow-doctype-decl on DocumentBuilderFactory", e);
        }
        try {
            dfactory.setFeature("http://xml.org/sax/features/external-general-entities", false);
        } catch (Exception e) {
            LOGGER.log(Level.WARNING, "Cannot set external-general-entities on DocumentBuilderFactory", e);
            throw new RuntimeException("Cannot set external-general-entities on DocumentBuilderFactory", e);
        }
        try {
            dfactory.setFeature("http://xml.org/sax/features/external-parameter-entities", false);
        } catch (Exception e) {
            LOGGER.log(Level.WARNING, "Cannot set external-parameter-entities on DocumentBuilderFactory", e);
            throw new RuntimeException("Cannot set external-parameter-entities on DocumentBuilderFactory", e);
        }
        try {
            dfactory.setFeature("http://apache.org/xml/features/nonvalidating/load-external-dtd", false);
        } catch (Exception e) {
            LOGGER.log(Level.WARNING, "Cannot set load-external-dtd on DocumentBuilderFactory", e);
            throw new RuntimeException("Cannot set load-external-dtd on DocumentBuilderFactory", e);
        }
     ...
     * @param isDir true when the File passed in is expected to be a directory, false when the handle is expected to be
     *     a file.
     ...
     * getChildElements purpose.
     *
     * <p>Used to help with XML manipulations. Returns *all* child elements of the specified name. An exception occurs
     * when the node is required and not found.
     *
     * @param root The root element to look for children in.
     * @param name The name of the child element to look for.
     ...
     *
     * <p>Used to help with XML manipulations. Returns the first child element of the specified name. An exception
     * occurs when the node is required and not found.
     *
     * @param root The root element to look for children in.
     * @param name The name of the child element to look for.
     * @param mandatory true when an exception should be thrown if the child element does not exist.
     ...
     * getChildElement purpose.
     *
     * <p>Used to help with XML manipulations. Returns the first child element of the specified name.
     *
     * @param root The root element to look for children in.
     * @param name The name of the child element to look for.
     * @return The child element found, null if not found.
     ...
     *
     * <p>Used to help with XML manipulations. Returns the first child integer attribute of the specified name. An
     * exception occurs when the node is required and not found.
     *
     ...
     * @param defaultValue a default value to return incase the attribute was not found. mutually exclusive with the
     *     Exception thrown.
     ...
     *
     * <p>Used to help with XML manipulations. Returns the first child text value of the specified element name.
     *
     * @param root The root element to look for children in.
     ...
     * getChildText purpose.
     *
     * <p>Used to help with XML manipulations. Returns the first child text value of the specified element name. An
     * exception occurs when the node is required and not found.
     *
     * @param root The root element to look for children in.
     * @param childName The name of the attribute to look for.
     ...
     * getChildText purpose.
     *
     * <p>Used to help with XML manipulations. Returns the text value of the specified element name. An exception occurs
     * when the node is required and not found.
     *
     * @param elem The root element to look for children in.
     * @param mandatory true when an exception should be thrown if the text does not exist.
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.WARNING, "Cannot set disallow-doctype-decl on SAXParserFactory", e);
                throw new RuntimeException("Cannot set disallow-doctype-decl on SAXParserFactory", e);
            }
            try {
                sf.setFeature("http://xml.org/sax/features/external-general-entities", false);
            } catch (Exception e) {
                LOGGER.log(Level.WARNING, "Cannot set external-general-entities on SAXParserFactory", e);
                throw new RuntimeException("Cannot set external-general-entities on SAXParserFactory", e);
            }
            try {
                sf.setFeature("http://xml.org/sax/features/external-parameter-entities", false);
            } catch (Exception e) {
                LOGGER.log(Level.WARNING, "Cannot set external-parameter-entities on SAXParserFactory", e);
                throw new RuntimeException("Cannot set external-parameter-entities on SAXParserFactory", e);
            }
            try {
                sf.setFeature("http://apache.org/xml/features/nonvalidating/load-external-dtd", false);
            } catch (Exception e) {
                LOGGER.log(Level.WARNING, "Cannot set load-external-dtd on SAXParserFactory", e);
                throw new RuntimeException("Cannot set load-external-dtd on SAXParserFactory", e);
            }
