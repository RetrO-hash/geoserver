...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Could not configure DocumentBuilderFactory securely", e);
            throw new RuntimeException("Could not configure DocumentBuilderFactory securely", e);
        }
