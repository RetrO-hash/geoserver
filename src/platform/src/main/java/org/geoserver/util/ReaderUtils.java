...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Error setting disallow-doctype-decl feature on DocumentBuilderFactory", e);
        }
        try {
            dfactory.setFeature("http://xml.org/sax/features/external-general-entities", false);
        } catch (Exception e) {
            LOGGER.log(Level.WARNING, "Error setting external-general-entities feature on DocumentBuilderFactory", e);
        }
        try {
            dfactory.setFeature("http://xml.org/sax/features/external-parameter-entities", false);
        } catch (Exception e) {
            LOGGER.log(Level.WARNING, "Error setting external-parameter-entities feature on DocumentBuilderFactory", e);
        }
        try {
            dfactory.setFeature("http://apache.org/xml/features/nonvalidating/load-external-dtd", false);
        } catch (Exception e) {
            LOGGER.log(Level.WARNING, "Error setting load-external-dtd feature on DocumentBuilderFactory", e);
        }
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.WARNING, "Error setting disallow-doctype-decl feature on SAXParserFactory", e);
            }
            try {
                sf.setFeature("http://xml.org/sax/features/external-general-entities", false);
            } catch (Exception e) {
                LOGGER.log(Level.WARNING, "Error setting external-general-entities feature on SAXParserFactory", e);
            }
            try {
                sf.setFeature("http://xml.org/sax/features/external-parameter-entities", false);
            } catch (Exception e) {
                LOGGER.log(Level.WARNING, "Error setting external-parameter-entities feature on SAXParserFactory", e);
            }
            try {
                sf.setFeature("http://apache.org/xml/features/nonvalidating/load-external-dtd", false);
            } catch (Exception e) {
                LOGGER.log(Level.WARNING, "Error setting load-external-dtd feature on SAXParserFactory", e);
            }
