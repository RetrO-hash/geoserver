...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Failed to configure secure XML parser factory", e);
            throw new RuntimeException("Failed to configure secure XML parser factory", e);
        }
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.WARNING, "Failed to configure secure SAX parser factory", e);
