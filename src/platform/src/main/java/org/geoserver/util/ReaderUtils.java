...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Failed to disable DOCTYPE declaration", e);
            throw new RuntimeException("Failed to disable DOCTYPE declaration", e);
        }
        try {
        ...
        try {
            ...
            throw new RuntimeException("Failed to disable external DTDs", e);
        }
