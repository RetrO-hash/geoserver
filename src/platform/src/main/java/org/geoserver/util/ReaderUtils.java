...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Failed to configure DocumentBuilderFactory for XXE protection", e);
            throw new RuntimeException("Failed to configure DocumentBuilderFactory for XXE protection", e);
        }
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Failed to configure SAXParserFactory for XXE protection", e);
                throw new RuntimeException("Failed to configure SAXParserFactory for XXE protection", e);
            }
