...
public class ReaderUtils {
    ...
    public static Element parse(Reader xml) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Failed to configure DocumentBuilderFactory for secure XML parsing", e);
            throw new RuntimeException("Failed to configure DocumentBuilderFactory for secure XML parsing", e);
        }
    ...
    public static void validate(
        ...
        try {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Failed to configure SAXParserFactory for secure XML parsing", e);
                throw new RuntimeException("Failed to configure SAXParserFactory for secure XML parsing", e);
            }
